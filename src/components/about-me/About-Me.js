        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-xm-12">
            ...
            <p>
              ...
              I will also break the project down intio weekly sprints and have weekly meetings with my client to report  progress and demonstrate already built UI's and functions. If I am doing a business site or ecommnerce site, I will thoroughly research my client's competition and use search engine optimization, so I can greatly improve my clients traffic to the site.
